...
-- Move Lines (Ctrl + Up/Down - Alt-free)
...
map("n", "<C-S-y>", "<cmd>t .-1<CR>", { desc = "Duplicate line up" })
map("i", "<C-S-d>", "<Esc><cmd>t .<CR>gi", { desc = "Duplicate line down" })
map("i", "<C-S-y>", "<Esc><cmd>t .-1<CR>gi", { desc = "Duplicate line up" })
map("v", "<C-S-d>", ":t '><CR>gv=gv", { desc = "Duplicate lines down" })
map("v", "<C-S-y>", ":t '<-1<CR>gv=gv", { desc = "Duplicate lines up" })
